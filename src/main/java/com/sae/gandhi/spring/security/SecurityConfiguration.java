...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	public CurrentUser currentUser(UsuariosDAO usuariosDAO) {
		final String username = SecurityUtils.getUsername();
		Usuarios user =
			username != null ? usuariosDAO.findByUsuarioLogin(username) :
				null;
		return () -> user;
	}
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable()
				...
				.anyRequest().hasAnyAuthority(SaeEnums.Rol.getAllRoles())
